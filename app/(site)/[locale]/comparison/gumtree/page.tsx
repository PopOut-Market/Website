...
const LOCALIZED_META: Partial<Record<Locale, { title: string; description: string }>> = {
    "es": {"title":"PopOut Market vs Gumtree | App de segunda mano en Melbourne, alternativa a Gumtree","description":"¿Buscas una alternativa a Gumtree en Melbourne? PopOut Market es la app gratuita de segunda mano: compra y vende muebles, electrodomésticos y artículos usados por barrios, con chat multilingüe traducido y operaciones más seguras. La comparativa ideal para estudiantes."},
    "fr": {"title":"PopOut Market vs Gumtree | Alternative à Gumtree d'occasion à Melbourne","description":"Vous cherchez une alternative à Gumtree à Melbourne ? PopOut Market est l'application d'occasion gratuite : meubles et électroménager de seconde main, petites annonces par quartier, messagerie multilingue traduite et transactions plus sûres. Le comparatif occasion idéal à Melbourne, parfait pour les étudiants."},
