...
export default async function SouthWharfSuburbPage({ params }: LocaleParams) {
  const locale = await localeFromParams(params);
  return (
    <>
      <BreadcrumbJsonLd
        ...
        items={[
          ...
          { name: "South Wharf", path: "/melbourne-suburbs/south-wharf" },
        ]}
      />
      <MelbourneSouthWharfSuburbContent />
    </>
  );
}
