...
export const COPY: Record<Locale, SiteCopy> = {
  en: {
    ...
    heroSecondaryPrefix: "Buy and sell with neighbours nearby, all in ",
    heroSecondaryLink: "English",
    heroSecondarySuffix: "",
    ...
    faqTitle: "PopOut FAQ",
    faqIntro: "These eight FAQs explain how PopOut supports faster posting, multilingual communication, safer transactions, and graduation season selling in Melbourne.",
    faqDisclaimerTitle: "Official note",
    faqDisclaimerBody: "This page is for product information only and does not constitute legal, financial, or safety guarantees. Features may vary by app version, region, and account context.",
    ...
    comparisonHubIntro: "This page helps users understand practical differences between PopOut and other commonly used second-hand marketplaces. The goal is a friendly, transparent guide so you can choose what fits your workflow.",
    comparisonHubPurposeTitle: "Why this page exists",
    comparisonHubPurposeBody: "Many users struggle with repetitive form filling, language barriers, and safer meetup coordination. We present PopOut's core experience in a structured format so feature differences are easier to evaluate.",
    comparisonHubDisclaimerTitle: "Official note and disclaimer",
    comparisonHubDisclaimerBody: "This page is for product education only. It is not legal advice and does not intend to discredit any third-party platform. Third-party trademarks and product names belong to their respective owners. Features can change over time; please verify current details on each platform's official channels.",
    ...
    comparisonHubCardFbBody: "Compare listing speed, multilingual messaging, and meetup safety workflow.",
    comparisonHubCardFbCta: "Read PopOut vs Facebook Marketplace",
    comparisonHubCardGumtreeBody: "Compare AI listing setup, student verification, and no-show prevention flow.",
    comparisonHubCardGumtreeCta: "Read PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree: Experience Comparison",
    comparisonGumtreeLead: "This page compares real-world workflow differences around listing setup, multilingual communication, and meetup safety in Melbourne second-hand use cases.",
    comparisonGumtreeDisclaimer: "Disclaimer: this page is for user education and product communication only. It is not legal advice. Gumtree and related marks belong to their respective owners. Third-party features may change over time.",
    comparisonGumtreeSection1Title: "1) AI-assisted listing setup",
    comparisonGumtreeSection1Body: "PopOut can draft title, description, and category suggestions from item photos. Users then review, set condition and target price, and choose options like delivery and negotiation to publish more quickly.",
    comparisonGumtreeSection2Title: "2) Built-in multilingual flow",
    comparisonGumtreeSection2Body: "PopOut supports English, Simplified Chinese, Traditional Chinese, Korean, Japanese, French, Spanish, and Vietnamese across posting and messaging, reducing language friction in a diverse city environment.",
    comparisonGumtreeSection3Title: "3) Structured meetup safety and no-show handling",
    comparisonGumtreeSection3Body: "PopOut combines safer meetup area suggestions, schedule planning, and QR-based on-site confirmation. This creates clearer completion records and helps address no-show behavior.",
    comparisonGumtreeSection4Title: "4) Student verification for campus communities",
    comparisonGumtreeSection4Body: "A student verification pathway helps improve trust and matching quality for university and accommodation-based transactions in Melbourne.",
    comparisonGumtreeTableTitle: "Feature snapshot (user-oriented)",
    comparisonGumtreeTableNote: "Note: the right column describes broad public usage patterns and may vary by account, region, or product updates.",
    ...
    comparisonGumtreeFeature2Other: "Cross-language communication often depends on user-side translation",
    comparisonGumtreeFeature3Title: "Meetup accountability",
    comparisonGumtreeFeature3Popout: "Schedule + on-site QR confirmation supports clearer records",
    comparisonGumtreeFeature3Other: "Accountability usually relies on private message history",
    ...
    comparisonGumtreeFinalBody: "If your priorities are posting speed, multilingual clarity, and stronger meetup confirmation workflow, PopOut may be the better fit. Validate current features based on your own region and usage.",
    ...
    comparisonGumtreeCard3Title: "Safety & Follow-through",
    comparisonGumtreeCard3Body: "Safer meetup guidance and no-show logic",
    comparisonFbH1: "PopOut vs Facebook Marketplace: Experience Comparison",
    comparisonFbLead: "This article compares practical workflow differences in listing setup, multilingual communication, and in-person trade safety. The intent is to help users choose a marketplace flow that fits everyday needs.",
    comparisonFbDisclaimer: "Disclaimer: this page is for product education only, not legal advice or a negative statement about any third-party platform. Facebook Marketplace and related marks belong to their respective owners. Feature availability may vary by region, account type, and product updates.",
    comparisonFbSection1Title: "1) AI-assisted listing from photos",
    comparisonFbSection1Body: "On PopOut, uploading item photos can generate draft title, description, and category suggestions. Users review, add context, set condition and price, then publish faster with fewer manual steps.",
    comparisonFbSection2Title: "2) Real-time multilingual communication",
    comparisonFbSection2Body: "PopOut supports English, Simplified Chinese, Traditional Chinese, Korean, Japanese, French, Spanish, and Vietnamese. Posts and chats can be read in each user's preferred language flow.",
    comparisonFbSection3Title: "3) Safety-zone guidance and meetup confirmation",
    comparisonFbSection3Body: "PopOut recommends nearby safer meetup areas and provides a schedule flow. After agreement, seller QR and buyer on-site scan can be used as a confirmation step, supporting clearer no-show handling.",
    comparisonFbSection4Title: "4) Student verification pathway in Melbourne",
    comparisonFbSection4Body: "For student communities and accommodation clusters, PopOut includes a student verification channel to improve trust and discoverability in campus-related transactions.",
    comparisonFbTableTitle: "Feature snapshot (user-oriented)",
    comparisonFbTableNote: "Note: the right column reflects common public usage patterns and may change over time.",
    ...
    comparisonFbFeature2Popout: "Post and chat content can be understood across supported languages",
    comparisonFbFeature2Other: "Cross-language communication often depends on self-translation",
    comparisonFbFeature3Title: "Meetup safety workflow",
    comparisonFbFeature3Popout: "Safer area suggestion + schedule + on-site QR confirmation",
    comparisonFbFeature3Other: "Meetup process is generally user-defined and less structured",
    ...
    comparisonFbFinalBody: "If your priorities are faster posting, smoother multilingual communication, and clearer meetup accountability, PopOut's workflow may fit better. Always verify current feature details in your own usage context.",
    ...
    comparisonFbCard3Title: "Meetup Confirmation",
    comparisonFbCard3Body: "Schedule plus on-site QR check-in flow",
  ...
  "zh-Hans": {
    ...
    faqIntro: "这里整理了用户最常问的 8 个问题，帮助你快速理解 PopOut 在发帖效率、多语言沟通、交易安全与毕业季出货上的核心能力。",
    faqDisclaimerTitle: "官方说明",
    faqDisclaimerBody: "本页用于产品信息说明，不构成法律、财务或安全承诺。不同地区与版本的功能可能存在差异，请以 App 内实际页面和官方公告为准。",
    ...
    comparisonHubIntro: "这个页面用于帮助你快速理解 PopOut 与其他常见二手平台在功能体验上的区别。我们希望提供清晰、友善、可执行的信息，帮助你根据自己的交易习惯选择合适的平台。",
    comparisonHubPurposeTitle: "为什么做这个页面",
    comparisonHubPurposeBody: "很多用户在发布和沟通阶段会遇到重复填写、语言障碍和线下见面安全等问题。我们将 PopOut 的核心流程做成结构化对比，让你更快判断哪些功能对你最有价值。",
    comparisonHubDisclaimerTitle: "官方说明与免责声明",
    comparisonHubDisclaimerBody: "本页面仅用于用户教育与产品说明，不构成对任何第三方平台的贬损或法律判断。文中提及的第三方名称属于其各自权利人；功能状态可能随第三方版本更新而变化，请以对方官方说明为准。",
    comparisonHubCardsTitle: "查看具体对比",
    comparisonHubCardsHint: "选择一个平台查看完整对比文章",
    comparisonHubCardFbBody: "查看在发帖效率、跨语言沟通、交易安全流程等方面的差异。",
    comparisonHubCardFbCta: "查看与 Facebook Marketplace 对比",
    comparisonHubCardGumtreeBody: "查看在 AI 填写、学生验证、见面确认机制等方面的差异。",
    comparisonHubCardGumtreeCta: "查看与 Gumtree 对比",
    comparisonGumtreeH1: "PopOut vs Gumtree：功能体验对比",
    comparisonGumtreeLead: "这页聚焦发布链路、沟通效率和线下安全流程，帮助你理解 PopOut 在墨尔本二手交易场景中的实际使用价值。",
    comparisonGumtreeDisclaimer: "免责声明：本页仅用于用户教育和产品说明，不构成法律意见。Gumtree 及相关名称属于其权利人。第三方平台功能可能变化，请以其官方信息为准。",
    comparisonGumtreeSection1Title: "1) AI 帮你完成初稿，缩短发布路径",
    comparisonGumtreeSection1Body: "PopOut 支持图片生成标题、描述与分类建议，用户只需要核对并补充即可。完成成色、价格、配送与议价选项后，就能更快发布，避免在大量分类中反复查找。",
    comparisonGumtreeSection2Title: "2) 多语言买卖沟通，覆盖墨尔本多民族用户",
    comparisonGumtreeSection2Body: "用户使用英语、简体中文、繁体中文、韩语、日语、法语、西班牙语、越南语输入后，可在帖子和聊天场景中按不同语言实时理解，降低沟通误解与等待成本。",
    comparisonGumtreeSection3Title: "3) 安全见面建议 + schedule + QR 确认",
    comparisonGumtreeSection3Body: "PopOut 会推荐附近安全交易区域，并将约见流程结构化。完成 schedule 后，卖家提供 QR code，买家到场扫码确认，有助于减少 no-show 并提升交易履约透明度。",
    comparisonGumtreeSection4Title: "4) 学生身份验证，服务校园与宿舍交易",
    comparisonGumtreeSection4Body: "针对墨尔本学生群体，PopOut 提供身份验证通道，帮助同校、同宿舍或相近学习生活圈用户更快建立信任并完成交易。",
    comparisonGumtreeTableTitle: "核心能力对照（用户视角）",
    comparisonGumtreeTableNote: "注：右侧内容为常见公开体验概述，具体功能会因版本和地区更新而变化。",
    ...
    comparisonGumtreeFeature3Title: "约见履约可追踪性",
    comparisonGumtreeFeature3Popout: "schedule + QR 到场确认，便于识别 no-show",
    comparisonGumtreeFeature3Other: "履约证明通常由双方私下沟通记录决定",
    ...
    comparisonGumtreeFinalBody: "如果你想减少发布时间、降低跨语言沟通成本，并获得更清晰的约见确认流程，PopOut 会更贴近你的使用目标。建议结合你常见的交易对象和频率做最终判断。",
    ...
    comparisonGumtreeCard3Title: "安全与履约",
    comparisonGumtreeCard3Body: "安全区建议与 no-show 识别机制",
    comparisonFbH1: "PopOut vs Facebook Marketplace：功能体验对比",
    comparisonFbLead: "这是一份面向用户的功能对比页，重点解释发布效率、跨语言沟通和线下交易安全流程上的体验差异。我们的目标是帮助你判断哪种流程更适合你的日常买卖节奏。",
    comparisonFbDisclaimer: "免责声明：本页仅用于产品信息说明，不构成法律意见，也不对第三方平台作价值判断。Facebook Marketplace 及相关名称为其权利人所有；功能会随版本调整，请以官方信息为准。",
    comparisonFbSection1Title: "1) AI 图片发帖，减少第一步的重复劳动",
    comparisonFbSection1Body: "在 PopOut，你上传图片后可自动生成标题、描述和类别建议。你只需快速检查并补充细节，再选择成色和价格即可发布。对于新用户或分类不熟悉的用户，这能显著减少初次发帖耗时。",
    comparisonFbSection2Title: "2) 多语言实时翻译，降低沟通门槛",
    comparisonFbSection2Body: "PopOut 支持英语、简体中文、繁体中文、韩语、日语、法语、西班牙语、越南语的输入与理解。帖子与聊天可以按用户语言实时展示，适合墨尔本多语言社区场景。",
    comparisonFbSection3Title: "3) 安全交易区域与约见确认机制",
    comparisonFbSection3Body: "PopOut 会推荐附近的安全见面区域，并提供 schedule 流程。约定完成后，卖家可出示 QR code，买家在见面地点扫码确认。未完成扫码会进入 no-show 记录逻辑，帮助提升履约透明度。",
    comparisonFbSection4Title: "4) 面向学生群体的身份验证通道",
    comparisonFbSection4Body: "针对墨尔本学生与学生公寓用户，PopOut 提供学生身份验证能力，帮助用户更容易识别同校或同住宿圈层的交易对象，提升交易匹配效率与信任感。",
    comparisonFbTableTitle: "核心功能对照（用户视角）",
    comparisonFbTableNote: "注：右侧为公开可观察到的通用体验描述，具体能力可能因地区、账号类型和产品版本而变化。",
    ...
    comparisonFbFeature3Title: "线下见面安全流程",
    comparisonFbFeature3Popout: "安全区域建议 + schedule + 见面扫码确认",
    comparisonFbFeature3Other: "常以用户自行约定为主，流程一致性依赖个人习惯",
    ...
    comparisonFbFinalBody: "如果你最在意“发帖快、跨语言沟通顺、线下履约可追踪”，PopOut 的流程会更适配。建议你结合自己常用语言、交易频率和见面场景做选择。",
    ...
    comparisonFbCard3Title: "约见确认",
    comparisonFbCard3Body: "schedule + 到场扫码，减少 no-show",
    notFoundTitle: "页面未找到",
  ...
  "zh-Hant": {
    ...
    faqIntro: "這裡整理了 8 個最常見問題，幫助你快速理解 PopOut 在發文效率、多語言溝通、交易安全與畢業季出貨上的核心能力。",
    faqDisclaimerTitle: "官方說明",
    faqDisclaimerBody: "本頁僅供產品資訊參考，不構成法律、財務或安全承諾。不同地區與版本的功能可能有所差異，請以 App 內實際功能與官方公告為準。",
    ...
    comparisonHubIntro: "此頁面用於幫助你快速理解 PopOut 與其他常見二手平台在功能體驗上的差異。我們希望提供清楚、友善、可執行的資訊，協助你依照自己的交易習慣做選擇。",
    comparisonHubPurposeTitle: "為什麼做這個頁面",
    comparisonHubPurposeBody: "許多使用者在發佈與溝通階段會遇到重複填寫、語言障礙與線下見面安全等問題。我們將 PopOut 的核心流程整理為結構化對比，讓你更快判斷哪些能力更符合需求。",
    comparisonHubDisclaimerTitle: "官方說明與免責聲明",
    comparisonHubDisclaimerBody: "本頁面僅用於使用者教育與產品資訊，不構成對任何第三方平台的貶抑或法律判斷。文中提及第三方名稱屬於其各自權利人；功能可能隨版本更新變動，請以各平台官方資訊為準。",
    comparisonHubCardsTitle: "查看詳細對比",
    comparisonHubCardsHint: "選擇一個平台查看完整對比文章",
    comparisonHubCardFbBody: "查看在發文效率、跨語言溝通與交易安全流程上的差異。",
    comparisonHubCardFbCta: "查看與 Facebook Marketplace 對比",
    comparisonHubCardGumtreeBody: "查看在 AI 填寫、學生驗證與見面確認機制上的差異。",
    comparisonHubCardGumtreeCta: "查看與 Gumtree 對比",
    comparisonGumtreeH1: "PopOut vs Gumtree：功能體驗比較",
    comparisonGumtreeLead: "本頁聚焦發佈流程、溝通效率與線下安全機制，協助你理解 PopOut 在墨爾本二手交易中的實際體驗差異。",
    comparisonGumtreeDisclaimer: "免責聲明：本頁僅供使用者教育與產品資訊參考，不構成法律意見。Gumtree 及相關名稱屬其權利人；功能可能隨版本更新調整，請以官方資訊為準。",
    comparisonGumtreeSection1Title: "1) AI 協助完成初稿，縮短發佈路徑",
    comparisonGumtreeSection1Body: "PopOut 可由圖片生成標題、描述與分類建議，使用者只需檢查補充，再設定成色、價格、配送與議價選項，即可更快完成發佈。",
    comparisonGumtreeSection2Title: "2) 多語言買賣溝通，適配多元社群",
    comparisonGumtreeSection2Body: "支援英語、簡中、繁中、韓語、日語、法語、西班牙語、越南語。貼文與聊天可依不同語言即時理解，降低溝通落差。",
    comparisonGumtreeSection3Title: "3) 安全見面建議 + schedule + QR 確認",
    comparisonGumtreeSection3Body: "PopOut 提供安全見面區建議與約見流程。完成 schedule 後，賣家提供 QR code，買家到場掃碼確認，有助降低 no-show 並提升履約透明度。",
    comparisonGumtreeSection4Title: "4) 學生驗證支援校園與宿舍交易",
    comparisonGumtreeSection4Body: "針對墨爾本學生族群，PopOut 提供身份驗證通道，讓同校或同宿舍圈層更容易互相發現與建立交易信任。",
    ...
    comparisonGumtreeFeature3Title: "約見履約可追蹤性",
    comparisonGumtreeFeature3Popout: "schedule + QR 到場確認，較易識別 no-show",
    comparisonGumtreeFeature3Other: "履約證明多依靠雙方私下溝通紀錄",
    ...
    comparisonGumtreeFinalBody: "若你重視發佈效率、跨語言溝通與約見確認流程，PopOut 通常更符合需求。建議依你的交易頻率與買賣對象做最終選擇。",
    ...
    comparisonGumtreeCard3Title: "安全與履約",
    comparisonGumtreeCard3Body: "安全區建議與 no-show 識別機制",
    comparisonFbH1: "PopOut vs Facebook Marketplace：功能體驗比較",
    comparisonFbLead: "這是一頁以使用者為中心的功能比較，聚焦發佈效率、跨語言溝通與線下交易安全流程差異，幫助你判斷哪種流程更符合日常買賣習慣。",
    comparisonFbDisclaimer: "免責聲明：本頁僅供產品資訊參考，不構成法律意見，也不對第三方平台作價值判斷。Facebook Marketplace 及相關名稱屬其權利人所有；功能可能隨版本調整，請以官方資訊為準。",
    comparisonFbSection1Title: "1) AI 圖片發文，減少重複填寫",
    comparisonFbSection1Body: "在 PopOut，上傳圖片後可自動生成標題、描述與分類建議。你只需快速檢查與補充，再填入成色與價格即可發佈，可有效縮短初次上架時間。",
    comparisonFbSection2Title: "2) 多語言即時翻譯，降低溝通門檻",
    comparisonFbSection2Body: "PopOut 支援英語、簡中、繁中、韓語、日語、法語、西班牙語、越南語。貼文與聊天可依使用者語言即時呈現，適合墨爾本多語社群。",
    comparisonFbSection3Title: "3) 安全見面區與約見確認機制",
    comparisonFbSection3Body: "PopOut 提供安全交易區域建議與 schedule 流程。完成約定後，賣家可出示 QR code，買家於見面地點掃碼確認；未完成掃碼會進入 no-show 記錄邏輯。",
    comparisonFbSection4Title: "4) 面向學生族群的身份驗證",
    comparisonFbSection4Body: "對於墨爾本學生與學生公寓族群，PopOut 提供學生驗證能力，讓同校或同住宿圈層更容易互相發現與交易。",
    ...
    comparisonFbFeature3Title: "線下交易安全流程",
    comparisonFbFeature3Popout: "安全區建議 + schedule + 見面掃碼確認",
    comparisonFbFeature3Other: "多以雙方自行約定為主，流程一致性因人而異",
    ...
    comparisonFbFinalBody: "若你重視「發文效率、跨語言溝通與履約可追蹤」，PopOut 流程通常更貼近需求。建議依照你的交易頻率與見面場景做最終選擇。",
    ...
    comparisonFbCard3Title: "約見確認",
    comparisonFbCard3Body: "schedule + 到場掃碼，降低 no-show",
    notFoundTitle: "找不到頁面",
  ...
  ko: {
    ...
    faqIntro: "이 여덟 가지 FAQ는 PopOut이 멜버른에서 더 빠른 게시, 다국어 소통, 더 안전한 거래, 졸업 시즌 판매를 어떻게 지원하는지 설명합니다.",
    faqDisclaimerTitle: "공식 안내",
    faqDisclaimerBody: "이 페이지는 제품 정보 제공 목적이며 법률·재무·안전을 보장하지 않습니다. 기능은 앱 버전, 지역, 계정 상황에 따라 다를 수 있습니다.",
    ...
    comparisonHubIntro: "이 페이지는 PopOut과 자주 쓰이는 다른 중고 마켓의 실질적인 차이를 이해하도록 돕습니다. 친근하고 투명한 안내를 통해 본인 방식에 맞는 플랫폼을 고르도록 하는 것이 목표입니다.",
    comparisonHubPurposeTitle: "이 페이지를 만든 이유",
    comparisonHubPurposeBody: "많은 사용자가 반복적인 양식 입력, 언어 장벽, 안전한 만남 조율에 어려움을 겪습니다. 기능 차이를 쉽게 평가할 수 있도록 PopOut의 핵심 경험을 구조화된 형태로 정리했습니다.",
    comparisonHubDisclaimerTitle: "공식 안내 및 면책 고지",
    comparisonHubDisclaimerBody: "이 페이지는 제품 안내 목적으로만 제공되며 법률 자문이 아니고 어떤 제3자 플랫폼도 폄하하려는 의도가 없습니다. 제3자 상표와 제품명은 각 권리자에게 귀속됩니다. 기능은 시간이 지나며 바뀔 수 있으니 각 플랫폼의 공식 채널에서 최신 정보를 확인하세요.",
    comparisonHubCardsTitle: "상세 비교 보기",
    comparisonHubCardsHint: "아래에서 플랫폼을 선택해 전체 비교 글을 확인하세요",
    comparisonHubCardFbBody: "등록 속도, 다국어 메시지, 만남 안전 절차의 차이를 비교하세요.",
    comparisonHubCardFbCta: "PopOut vs Facebook Marketplace 보기",
    comparisonHubCardGumtreeBody: "AI 등록 설정, 학생 인증, 노쇼 방지 절차의 차이를 비교하세요.",
    comparisonHubCardGumtreeCta: "PopOut vs Gumtree 보기",
    comparisonGumtreeH1: "PopOut vs Gumtree: 사용 경험 비교",
    comparisonGumtreeLead: "이 페이지는 멜버른 중고 거래 상황에서 등록 설정, 다국어 소통, 만남 안전과 관련된 실제 사용 흐름의 차이를 비교합니다.",
    comparisonGumtreeDisclaimer: "면책 고지: 이 페이지는 사용자 안내와 제품 설명 목적으로만 제공되며 법률 자문이 아닙니다. Gumtree 및 관련 상표는 각 권리자에게 귀속됩니다. 제3자 기능은 시간이 지나며 바뀔 수 있습니다.",
    comparisonGumtreeSection1Title: "1) AI가 돕는 등록 설정",
    comparisonGumtreeSection1Body: "PopOut은 물품 사진을 바탕으로 제목, 설명, 카테고리 제안을 작성해 줍니다. 사용자는 이를 검토하고 상태와 희망 가격을 정한 뒤 배송이나 흥정 같은 옵션을 선택해 더 빠르게 등록할 수 있습니다.",
    comparisonGumtreeSection2Title: "2) 내장된 다국어 흐름",
    comparisonGumtreeSection2Body: "PopOut은 영어, 중국어 간체, 중국어 번체, 한국어, 일본어, 프랑스어, 스페인어, 베트남어를 등록과 메시지에서 지원해, 다양한 도시 환경에서 언어 장벽을 줄여 줍니다.",
    comparisonGumtreeSection3Title: "3) 체계적인 만남 안전과 노쇼 처리",
    comparisonGumtreeSection3Body: "PopOut은 더 안전한 만남 장소 추천, 일정 계획, QR 기반 현장 확인을 결합합니다. 이를 통해 거래 완료 기록이 더 명확해지고 노쇼 문제를 줄이는 데 도움이 됩니다.",
    comparisonGumtreeSection4Title: "4) 캠퍼스 커뮤니티를 위한 학생 인증",
    comparisonGumtreeSection4Body: "학생 인증 절차는 멜버른의 대학 및 숙소 기반 거래에서 신뢰와 매칭 품질을 높이는 데 도움이 됩니다.",
    comparisonGumtreeTableTitle: "기능 요약 (사용자 관점)",
    comparisonGumtreeTableNote: "참고: 오른쪽 열은 일반적인 공개 이용 양상을 설명하며 계정, 지역, 제품 업데이트에 따라 달라질 수 있습니다.",
    ...
    comparisonGumtreeFeature3Title: "만남 이행 책임",
    comparisonGumtreeFeature3Popout: "일정 + 현장 QR 확인으로 더 명확한 기록 지원",
    comparisonGumtreeFeature3Other: "이행 책임은 보통 개인 메시지 기록에 의존",
    ...
    comparisonGumtreeFinalBody: "등록 속도, 다국어 명확성, 더 확실한 만남 확인 절차를 중요하게 여긴다면 PopOut이 더 잘 맞을 수 있습니다. 본인의 지역과 사용 방식에 따라 현재 기능을 확인해 보세요.",
    ...
    comparisonGumtreeCard3Title: "안전과 이행",
    comparisonGumtreeCard3Body: "더 안전한 만남 안내와 노쇼 처리 로직",
    comparisonFbH1: "PopOut vs Facebook Marketplace: 사용 경험 비교",
    comparisonFbLead: "이 글은 등록 설정, 다국어 소통, 대면 거래 안전에서의 실질적인 사용 흐름 차이를 비교합니다. 일상적인 필요에 맞는 마켓 흐름을 고르도록 돕는 것이 목적입니다.",
    comparisonFbDisclaimer: "면책 고지: 이 페이지는 제품 안내 목적으로만 제공되며 법률 자문이 아니고 어떤 제3자 플랫폼에 대한 부정적 평가도 아닙니다. Facebook Marketplace 및 관련 상표는 각 권리자에게 귀속됩니다. 기능 제공 여부는 지역, 계정 유형, 제품 업데이트에 따라 달라질 수 있습니다.",
    comparisonFbSection1Title: "1) 사진으로 시작하는 AI 등록",
    comparisonFbSection1Body: "PopOut에서는 물품 사진을 올리면 제목, 설명, 카테고리 초안을 만들어 줍니다. 사용자는 이를 검토하고 내용을 보완한 뒤 상태와 가격을 정하면, 수동 단계를 줄이며 더 빠르게 등록할 수 있습니다.",
    comparisonFbSection2Title: "2) 실시간 다국어 소통",
    comparisonFbSection2Body: "PopOut은 영어, 중국어 간체, 중국어 번체, 한국어, 일본어, 프랑스어, 스페인어, 베트남어를 지원합니다. 게시물과 채팅을 각 사용자가 선호하는 언어로 읽을 수 있습니다.",
    comparisonFbSection3Title: "3) 안전 구역 안내와 만남 확인",
    comparisonFbSection3Body: "PopOut은 가까운 더 안전한 만남 장소를 추천하고 일정 흐름을 제공합니다. 합의 후 판매자 QR과 구매자의 현장 스캔을 확인 단계로 사용할 수 있어 노쇼 처리가 더 명확해집니다.",
    comparisonFbSection4Title: "4) 멜버른 학생 인증 절차",
    comparisonFbSection4Body: "학생 커뮤니티와 숙소 밀집 지역을 위해 PopOut은 학생 인증 채널을 제공해, 캠퍼스 관련 거래에서 신뢰와 노출을 높입니다.",
    comparisonFbTableTitle: "기능 요약 (사용자 관점)",
    comparisonFbTableNote: "참고: 오른쪽 열은 일반적인 공개 이용 양상을 반영하며 시간이 지나며 바뀔 수 있습니다.",
    ...
    comparisonFbFeature3Title: "만남 안전 절차",
    comparisonFbFeature3Popout: "더 안전한 장소 추천 + 일정 + 현장 QR 확인",
    comparisonFbFeature3Other: "만남 절차는 대체로 사용자가 정하며 덜 체계적",
    ...
    comparisonFbFinalBody: "더 빠른 등록, 더 매끄러운 다국어 소통, 더 명확한 만남 이행 책임을 중요하게 여긴다면 PopOut의 흐름이 더 잘 맞을 수 있습니다. 본인의 사용 맥락에서 현재 기능을 꼭 확인하세요.",
    ...
    comparisonFbCard3Title: "만남 확인",
    comparisonFbCard3Body: "일정과 현장 QR 체크인 흐름",
  ...
  ja: {
    ...
    faqIntro: "この8つのFAQでは、PopOutがメルボルンでの素早い出品、多言語コミュニケーション、より安全な取引、卒業シーズンの販売をどのように支えるかを説明します。",
    faqDisclaimerTitle: "公式の注意事項",
    faqDisclaimerBody: "このページは製品情報のみを目的としており、法的・財務的・安全上の保証を行うものではありません。機能はアプリのバージョン、地域、アカウントの状況により異なる場合があります。",
    ...
    comparisonHubIntro: "このページは、PopOut とよく使われる他の中古マーケットの実用的な違いを理解するのに役立ちます。あなたの使い方に合うものを選べるよう、わかりやすく公正な案内を目指しています。",
    comparisonHubPurposeTitle: "このページを設けた理由",
    comparisonHubPurposeBody: "多くのユーザーが、繰り返しの入力作業、言語の壁、安全な待ち合わせの調整に苦労しています。機能の違いを評価しやすいよう、PopOut の中心的な体験を整理してご紹介します。",
    comparisonHubDisclaimerTitle: "公式の注記および免責事項",
    comparisonHubDisclaimerBody: "このページは製品の説明のみを目的としており、法的助言ではなく、いかなる第三者プラットフォームをも貶める意図はありません。第三者の商標および製品名はそれぞれの権利者に帰属します。機能は変更される場合がありますので、各プラットフォームの公式情報で最新の内容をご確認ください。",
    comparisonHubCardsTitle: "詳細な比較を開く",
    comparisonHubCardsHint: "下からプラットフォームを選ぶと、記事形式の詳しい比較が見られます",
    comparisonHubCardFbBody: "出品スピード、多言語メッセージ、待ち合わせの安全フローの違いを比較します。",
    comparisonHubCardFbCta: "PopOut vs Facebook Marketplace を読む",
    comparisonHubCardGumtreeBody: "AI による出品作成、学生認証、ノーショー防止フローの違いを比較します。",
    comparisonHubCardGumtreeCta: "PopOut vs Gumtree を読む",
    comparisonGumtreeH1: "PopOut vs Gumtree：使用体験の比較",
    comparisonGumtreeLead: "このページでは、メルボルンの中古取引において、出品作成・多言語コミュニケーション・待ち合わせの安全に関する実際の使い勝手の違いを比較します。",
    comparisonGumtreeDisclaimer: "免責事項：このページはユーザー向けの説明と製品紹介のみを目的としており、法的助言ではありません。Gumtree および関連する商標はそれぞれの権利者に帰属します。第三者の機能は変更される場合があります。",
    comparisonGumtreeSection1Title: "1) AI による出品作成のサポート",
    comparisonGumtreeSection1Body: "PopOut は商品写真からタイトル・説明・カテゴリの提案を作成できます。ユーザーはそれを確認し、状態や希望価格を設定し、配送や値引きなどのオプションを選ぶことで、より早く出品できます。",
    comparisonGumtreeSection2Title: "2) 多言語に対応した一連の流れ",
    comparisonGumtreeSection2Body: "PopOut は英語、簡体字中国語、繁体字中国語、韓国語、日本語、フランス語、スペイン語、ベトナム語に出品とメッセージで対応し、多様な都市環境での言語の壁を減らします。",
    comparisonGumtreeSection3Title: "3) 体系化された待ち合わせの安全とノーショー対応",
    comparisonGumtreeSection3Body: "PopOut は、より安全な待ち合わせ場所の提案、スケジュール調整、QR による現地確認を組み合わせています。これにより取引完了の記録が明確になり、ノーショーへの対処に役立ちます。",
    comparisonGumtreeSection4Title: "4) キャンパスコミュニティ向けの学生認証",
    comparisonGumtreeSection4Body: "学生認証の仕組みは、メルボルンの大学や住居を中心とした取引における信頼性とマッチングの質を高めるのに役立ちます。",
    comparisonGumtreeTableTitle: "機能の概要（ユーザー視点）",
    comparisonGumtreeTableNote: "注：右の列は一般的な利用傾向を示したもので、アカウント、地域、製品の更新によって異なる場合があります。",
    ...
    comparisonGumtreeFeature3Title: "待ち合わせの履行確認",
    comparisonGumtreeFeature3Popout: "スケジュール＋現地 QR 確認で記録がより明確に",
    comparisonGumtreeFeature3Other: "履行の確認は通常、個別メッセージの履歴に依存",
    ...
    comparisonGumtreeFinalBody: "出品スピード、多言語でのわかりやすさ、より確実な待ち合わせ確認の流れを重視するなら、PopOut が合うかもしれません。お住まいの地域や使い方に合わせて、現在の機能をご確認ください。",
    ...
    comparisonGumtreeCard3Title: "安全と履行",
    comparisonGumtreeCard3Body: "より安全な待ち合わせの案内とノーショー対応",
    comparisonFbH1: "PopOut vs Facebook Marketplace：使用体験の比較",
    comparisonFbLead: "この記事では、出品作成、多言語コミュニケーション、対面取引の安全における実用的な流れの違いを比較します。日常のニーズに合うマーケットの使い方を選ぶ手助けが目的です。",
    comparisonFbDisclaimer: "免責事項：このページは製品の説明のみを目的としており、法的助言や第三者プラットフォームに対する否定的な評価ではありません。Facebook Marketplace および関連する商標はそれぞれの権利者に帰属します。機能の提供状況は地域、アカウントの種類、製品の更新によって異なる場合があります。",
    comparisonFbSection1Title: "1) 写真からの AI 出品サポート",
    comparisonFbSection1Body: "PopOut では、商品写真をアップロードするとタイトル・説明・カテゴリの下書きが生成されます。ユーザーはそれを確認して情報を補い、状態と価格を設定するだけで、手作業を減らしてより早く出品できます。",
    comparisonFbSection2Title: "2) リアルタイムの多言語コミュニケーション",
    comparisonFbSection2Body: "PopOut は英語、簡体字中国語、繁体字中国語、韓国語、日本語、フランス語、スペイン語、ベトナム語に対応しています。投稿やチャットを各ユーザーの好みの言語で読むことができます。",
    comparisonFbSection3Title: "3) 安全エリアの案内と待ち合わせ確認",
    comparisonFbSection3Body: "PopOut は近くのより安全な待ち合わせ場所を提案し、スケジュールの流れを提供します。合意後、出品者の QR と購入者の現地スキャンを確認ステップとして利用でき、ノーショー対応がより明確になります。",
    comparisonFbSection4Title: "4) メルボルンの学生認証の仕組み",
    comparisonFbSection4Body: "学生コミュニティや住居が集まる地域に向けて、PopOut は学生認証の仕組みを備えており、キャンパス関連の取引における信頼性と見つけやすさを高めます。",
    comparisonFbTableTitle: "機能の概要（ユーザー視点）",
    comparisonFbTableNote: "注：右の列は一般的な利用傾向を反映したもので、時間とともに変わる場合があります。",
    ...
    comparisonFbFeature3Title: "待ち合わせの安全フロー",
    comparisonFbFeature3Popout: "より安全な場所の提案＋スケジュール＋現地 QR 確認",
    comparisonFbFeature3Other: "待ち合わせの流れは基本的にユーザー任せで、体系化されていない",
    comparisonFbFeature4Title: "学生向けの信頼レイヤー",
    comparisonFbFeature4Popout: "キャンパスや住居のマッチング向けの学生認証の仕組み",
    comparisonFbFeature4Other: "学生専用の本人確認の流れは限られているか、提供されていないことが多い",
    comparisonFbFinalTitle: "この比較の使い方",
    comparisonFbFinalBody: "より速い出品、よりスムーズな多言語コミュニケーション、より明確な待ち合わせの履行確認を重視するなら、PopOut の流れが合うかもしれません。ご自身の使い方の中で、現在の機能を必ずご確認ください。",
    ...
    comparisonFbCard3Title: "待ち合わせ確認",
    comparisonFbCard3Body: "スケジュールと現地 QR チェックインの流れ",
  ...
  vi: {
    ...
    faqIntro: "Tám câu hỏi thường gặp này giải thích cách PopOut hỗ trợ đăng tin nhanh hơn, giao tiếp đa ngôn ngữ, giao dịch an toàn hơn và bán đồ mùa tốt nghiệp tại Melbourne.",
    faqDisclaimerTitle: "Lưu ý chính thức",
    faqDisclaimerBody: "Trang này chỉ cung cấp thông tin sản phẩm và không cấu thành bảo đảm về pháp lý, tài chính hay an toàn. Tính năng có thể khác nhau theo phiên bản ứng dụng, khu vực và tài khoản.",
    ...
    comparisonHubIntro: "Trang này giúp bạn hiểu những khác biệt thực tế giữa PopOut và các chợ đồ cũ phổ biến khác. Mục tiêu là một hướng dẫn thân thiện, minh bạch để bạn chọn nền tảng phù hợp với cách dùng của mình.",
    comparisonHubPurposeTitle: "Vì sao có trang này",
    comparisonHubPurposeBody: "Nhiều người gặp khó khăn với việc nhập biểu mẫu lặp đi lặp lại, rào cản ngôn ngữ và việc sắp xếp gặp mặt an toàn. Chúng tôi trình bày trải nghiệm cốt lõi của PopOut theo dạng có cấu trúc để dễ đánh giá khác biệt tính năng.",
    comparisonHubDisclaimerTitle: "Lưu ý chính thức và miễn trừ trách nhiệm",
    comparisonHubDisclaimerBody: "Trang này chỉ nhằm giới thiệu sản phẩm. Đây không phải là tư vấn pháp lý và không nhằm hạ thấp bất kỳ nền tảng bên thứ ba nào. Thương hiệu và tên sản phẩm của bên thứ ba thuộc về chủ sở hữu tương ứng. Tính năng có thể thay đổi theo thời gian; vui lòng kiểm tra thông tin mới nhất trên kênh chính thức của từng nền tảng.",
    comparisonHubCardsTitle: "Xem so sánh chi tiết",
    comparisonHubCardsHint: "Chọn một nền tảng bên dưới để xem bài so sánh đầy đủ",
    comparisonHubCardFbBody: "So sánh tốc độ đăng tin, nhắn tin đa ngôn ngữ và quy trình gặp mặt an toàn.",
    comparisonHubCardFbCta: "Đọc PopOut vs Facebook Marketplace",
    comparisonHubCardGumtreeBody: "So sánh thiết lập đăng tin bằng AI, xác minh sinh viên và quy trình ngăn vắng mặt.",
    comparisonHubCardGumtreeCta: "Đọc PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree: So sánh trải nghiệm",
    comparisonGumtreeLead: "Trang này so sánh những khác biệt thực tế trong quy trình đăng tin, giao tiếp đa ngôn ngữ và an toàn khi gặp mặt trong các tình huống mua bán đồ cũ ở Melbourne.",
    comparisonGumtreeDisclaimer: "Miễn trừ trách nhiệm: trang này chỉ nhằm giới thiệu cho người dùng và sản phẩm, không phải tư vấn pháp lý. Gumtree và các nhãn hiệu liên quan thuộc về chủ sở hữu tương ứng. Tính năng của bên thứ ba có thể thay đổi theo thời gian.",
    comparisonGumtreeSection1Title: "1) Thiết lập đăng tin có AI hỗ trợ",
    comparisonGumtreeSection1Body: "PopOut có thể soạn gợi ý tiêu đề, mô tả và danh mục từ ảnh sản phẩm. Người dùng chỉ cần xem lại, đặt tình trạng và giá mong muốn, rồi chọn các tùy chọn như giao hàng và thương lượng để đăng nhanh hơn.",
    comparisonGumtreeSection2Title: "2) Luồng đa ngôn ngữ tích hợp sẵn",
    comparisonGumtreeSection2Body: "PopOut hỗ trợ tiếng Anh, tiếng Trung giản thể, tiếng Trung phồn thể, tiếng Hàn, tiếng Nhật, tiếng Pháp, tiếng Tây Ban Nha và tiếng Việt khi đăng tin và nhắn tin, giúp giảm rào cản ngôn ngữ trong một thành phố đa dạng.",
    comparisonGumtreeSection3Title: "3) An toàn khi gặp mặt có cấu trúc và xử lý vắng mặt",
    comparisonGumtreeSection3Body: "PopOut kết hợp gợi ý khu vực gặp mặt an toàn hơn, lập lịch hẹn và xác nhận tại chỗ bằng QR. Điều này tạo ra hồ sơ hoàn tất rõ ràng hơn và giúp xử lý tình trạng vắng mặt.",
    comparisonGumtreeSection4Title: "4) Xác minh sinh viên cho cộng đồng trường học",
    comparisonGumtreeSection4Body: "Quy trình xác minh sinh viên giúp nâng cao mức độ tin cậy và chất lượng kết nối cho các giao dịch quanh trường học và nơi ở tại Melbourne.",
    comparisonGumtreeTableTitle: "Tóm tắt tính năng (theo góc nhìn người dùng)",
    comparisonGumtreeTableNote: "Lưu ý: cột bên phải mô tả các mẫu sử dụng phổ biến và có thể khác nhau tùy tài khoản, khu vực hoặc bản cập nhật sản phẩm.",
    comparisonGumtreeFeature1Title: "Thời gian chuẩn bị đăng tin",
    comparisonGumtreeFeature1Popout: "AI soạn các trường chính trước, người dùng hoàn thiện chi tiết",
    ...
    comparisonGumtreeFeature2Other: "Giao tiếp khác ngôn ngữ thường phụ thuộc vào việc người dùng tự dịch",
    comparisonGumtreeFeature3Title: "Trách nhiệm khi gặp mặt",
    comparisonGumtreeFeature3Popout: "Lịch hẹn + xác nhận QR tại chỗ giúp hồ sơ rõ ràng hơn",
    comparisonGumtreeFeature3Other: "Trách nhiệm thường dựa vào lịch sử tin nhắn riêng",
    ...
    comparisonGumtreeFeature4Other: "Quy trình xác minh danh tính sinh viên riêng có thể bị hạn chế",
    comparisonGumtreeFinalTitle: "Gợi ý lựa chọn",
    comparisonGumtreeFinalBody: "Nếu bạn ưu tiên tốc độ đăng tin, sự rõ ràng đa ngôn ngữ và quy trình xác nhận gặp mặt chắc chắn hơn, PopOut có thể phù hợp hơn. Hãy kiểm tra các tính năng hiện tại theo khu vực và cách dùng của bạn.",
    ...
    comparisonGumtreeCard3Title: "An toàn và thực hiện",
    comparisonGumtreeCard3Body: "Hướng dẫn gặp mặt an toàn hơn và xử lý vắng mặt",
    comparisonFbH1: "PopOut vs Facebook Marketplace: So sánh trải nghiệm",
    comparisonFbLead: "Bài viết này so sánh những khác biệt thực tế trong quy trình đăng tin, giao tiếp đa ngôn ngữ và an toàn khi giao dịch trực tiếp. Mục tiêu là giúp bạn chọn cách dùng chợ phù hợp với nhu cầu hằng ngày.",
    comparisonFbDisclaimer: "Miễn trừ trách nhiệm: trang này chỉ nhằm giới thiệu sản phẩm, không phải tư vấn pháp lý hay tuyên bố tiêu cực về bất kỳ nền tảng bên thứ ba nào. Facebook Marketplace và các nhãn hiệu liên quan thuộc về chủ sở hữu tương ứng. Khả năng có tính năng có thể khác nhau tùy khu vực, loại tài khoản và bản cập nhật sản phẩm.",
    comparisonFbSection1Title: "1) Đăng tin bằng AI từ ảnh",
    comparisonFbSection1Body: "Trên PopOut, tải ảnh sản phẩm lên có thể tạo bản nháp tiêu đề, mô tả và gợi ý danh mục. Người dùng xem lại, bổ sung thông tin, đặt tình trạng và giá, rồi đăng nhanh hơn với ít thao tác thủ công.",
    comparisonFbSection2Title: "2) Giao tiếp đa ngôn ngữ theo thời gian thực",
    comparisonFbSection2Body: "PopOut hỗ trợ tiếng Anh, tiếng Trung giản thể, tiếng Trung phồn thể, tiếng Hàn, tiếng Nhật, tiếng Pháp, tiếng Tây Ban Nha và tiếng Việt. Bài đăng và trò chuyện có thể đọc bằng ngôn ngữ ưa thích của từng người dùng.",
    comparisonFbSection3Title: "3) Hướng dẫn khu vực an toàn và xác nhận gặp mặt",
    comparisonFbSection3Body: "PopOut gợi ý các khu vực gặp mặt an toàn hơn ở gần và cung cấp luồng đặt lịch. Sau khi thống nhất, QR của người bán và việc người mua quét tại chỗ có thể dùng làm bước xác nhận, giúp xử lý vắng mặt rõ ràng hơn.",
    comparisonFbSection4Title: "4) Quy trình xác minh sinh viên tại Melbourne",
    comparisonFbSection4Body: "Đối với cộng đồng sinh viên và các khu nhà ở, PopOut có kênh xác minh sinh viên để tăng độ tin cậy và khả năng được tìm thấy trong các giao dịch quanh trường học.",
    comparisonFbTableTitle: "Tóm tắt tính năng (theo góc nhìn người dùng)",
    comparisonFbTableNote: "Lưu ý: cột bên phải phản ánh các mẫu sử dụng phổ biến và có thể thay đổi theo thời gian.",
    ...
    comparisonFbFeature2Popout: "Nội dung bài đăng và trò chuyện có thể hiểu được qua các ngôn ngữ được hỗ trợ",
    comparisonFbFeature2Other: "Giao tiếp khác ngôn ngữ thường phụ thuộc vào việc tự dịch",
    comparisonFbFeature3Title: "Quy trình an toàn khi gặp mặt",
    comparisonFbFeature3Popout: "Gợi ý khu vực an toàn hơn + lịch hẹn + xác nhận QR tại chỗ",
    comparisonFbFeature3Other: "Quá trình gặp mặt thường do người dùng tự định và ít có cấu trúc",
    ...
    comparisonFbFeature4Other: "Quy trình xác minh danh tính sinh viên riêng thường hạn chế hoặc không có",
    comparisonFbFinalTitle: "Cách sử dụng phần so sánh này",
    comparisonFbFinalBody: "Nếu bạn ưu tiên đăng tin nhanh hơn, giao tiếp đa ngôn ngữ mượt mà hơn và trách nhiệm gặp mặt rõ ràng hơn, quy trình của PopOut có thể phù hợp hơn. Hãy luôn kiểm tra chi tiết tính năng hiện tại theo cách dùng của bạn.",
    ...
    comparisonFbCard3Title: "Xác nhận gặp mặt",
    comparisonFbCard3Body: "Lịch hẹn cùng quy trình quét QR tại chỗ",
  ...
  fr: {
    ...
    heroRotatingItems: ["meubles", "électronique", "vélos", "manuels scolaires", "ustensiles de cuisine", "vêtements"],
    heroLocationSuffix: "",
    contactBack: "Retour à l’accueil",
    contactHint: "Indiquez votre question ou votre demande de partenariat, nous vous répondrons par e-mail.",
    ...
    faqTitle: "FAQ PopOut",
    faqIntro: "Ces huit questions fréquentes expliquent comment PopOut facilite la publication rapide, la communication multilingue, des transactions plus sûres et les ventes de fin d’études à Melbourne.",
    faqDisclaimerTitle: "Note officielle",
    faqDisclaimerBody: "Cette page est fournie à titre informatif sur le produit et ne constitue aucune garantie juridique, financière ou de sécurité. Les fonctionnalités peuvent varier selon la version de l’application, la région et le compte.",
    ...
    comparisonHubIntro: "Cette page vous aide à comprendre les différences concrètes entre PopOut et d'autres marchés de seconde main courants. L'objectif est un guide clair et transparent pour choisir ce qui convient à votre usage.",
    comparisonHubPurposeTitle: "Pourquoi cette page",
    comparisonHubPurposeBody: "Beaucoup d'utilisateurs peinent avec la saisie répétitive de formulaires, les barrières linguistiques et l'organisation de rencontres plus sûres. Nous présentons l'expérience clé de PopOut de façon structurée pour faciliter l'évaluation des différences.",
    comparisonHubDisclaimerTitle: "Note officielle et avertissement",
    comparisonHubDisclaimerBody: "Cette page sert uniquement à présenter le produit. Il ne s'agit pas d'un conseil juridique et elle ne vise à discréditer aucune plateforme tierce. Les marques et noms de produits tiers appartiennent à leurs propriétaires respectifs. Les fonctionnalités peuvent évoluer ; veuillez vérifier les détails actuels sur les canaux officiels de chaque plateforme.",
    ...
    comparisonHubCardFbBody: "Comparez la rapidité de mise en ligne, la messagerie multilingue et le déroulé des rencontres plus sûres.",
    comparisonHubCardFbCta: "Lire PopOut vs Facebook Marketplace",
    comparisonHubCardGumtreeBody: "Comparez la création d'annonce par IA, la vérification étudiante et la prévention des absences.",
    comparisonHubCardGumtreeCta: "Lire PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree : comparaison de l'expérience",
    comparisonGumtreeLead: "Cette page compare les différences concrètes de déroulement autour de la mise en ligne, de la communication multilingue et de la sécurité des rencontres dans les usages de seconde main à Melbourne.",
    comparisonGumtreeDisclaimer: "Avertissement : cette page sert uniquement à informer les utilisateurs et à présenter le produit. Il ne s'agit pas d'un conseil juridique. Gumtree et les marques associées appartiennent à leurs propriétaires respectifs. Les fonctionnalités tierces peuvent évoluer.",
    comparisonGumtreeSection1Title: "1) Mise en ligne assistée par IA",
    comparisonGumtreeSection1Body: "PopOut peut générer un brouillon de titre, de description et de suggestions de catégorie à partir des photos de l'article. L'utilisateur les vérifie, indique l'état et le prix souhaité, puis choisit des options comme la livraison et la négociation pour publier plus vite.",
    comparisonGumtreeSection2Title: "2) Parcours multilingue intégré",
    comparisonGumtreeSection2Body: "PopOut prend en charge l'anglais, le chinois simplifié, le chinois traditionnel, le coréen, le japonais, le français, l'espagnol et le vietnamien pour la publication et la messagerie, réduisant les frictions linguistiques dans une ville diverse.",
    comparisonGumtreeSection3Title: "3) Sécurité des rencontres structurée et gestion des absences",
    comparisonGumtreeSection3Body: "PopOut combine des suggestions de lieux de rencontre plus sûrs, la planification d'un rendez-vous et une confirmation sur place par QR. Cela crée des traces d'achèvement plus claires et aide à gérer les absences.",
    comparisonGumtreeSection4Title: "4) Vérification étudiante pour les communautés de campus",
    comparisonGumtreeSection4Body: "Un parcours de vérification étudiante aide à renforcer la confiance et la qualité des mises en relation pour les transactions liées aux universités et aux logements à Melbourne.",
    comparisonGumtreeTableTitle: "Aperçu des fonctionnalités (point de vue utilisateur)",
    comparisonGumtreeTableNote: "Remarque : la colonne de droite décrit des usages publics généraux et peut varier selon le compte, la région ou les mises à jour du produit.",
    comparisonGumtreeFeature1Title: "Temps de préparation d'une annonce",
    comparisonGumtreeFeature1Popout: "L'IA rédige d'abord les champs clés, l'utilisateur finalise les détails",
    ...
    comparisonGumtreeFeature2Other: "La communication entre langues dépend souvent de la traduction par l'utilisateur",
    comparisonGumtreeFeature3Title: "Responsabilité lors des rencontres",
    comparisonGumtreeFeature3Popout: "Rendez-vous + confirmation QR sur place pour des traces plus claires",
    comparisonGumtreeFeature3Other: "La responsabilité repose généralement sur l'historique des messages privés",
    comparisonGumtreeFeature4Title: "Mécanisme de confiance dédié aux étudiants",
    comparisonGumtreeFeature4Popout: "La vérification étudiante facilite les mises en relation sur le campus",
    ...
    comparisonGumtreeFinalBody: "Si vos priorités sont la rapidité de publication, la clarté multilingue et un meilleur déroulé de confirmation des rencontres, PopOut peut mieux vous convenir. Vérifiez les fonctionnalités actuelles selon votre région et votre usage.",
    ...
    comparisonGumtreeCard2Body: "Prend en charge les principaux parcours de transaction multilingues",
    comparisonGumtreeCard3Title: "Sécurité et suivi",
    comparisonGumtreeCard3Body: "Conseils pour des rencontres plus sûres et gestion des absences",
    comparisonFbH1: "PopOut vs Facebook Marketplace : comparaison de l'expérience",
    comparisonFbLead: "Cet article compare les différences concrètes de déroulement dans la mise en ligne, la communication multilingue et la sécurité des échanges en personne. L'objectif est d'aider à choisir un fonctionnement adapté aux besoins quotidiens.",
    comparisonFbDisclaimer: "Avertissement : cette page sert uniquement à présenter le produit, et non un conseil juridique ni une déclaration négative sur une plateforme tierce. Facebook Marketplace et les marques associées appartiennent à leurs propriétaires respectifs. La disponibilité des fonctionnalités peut varier selon la région, le type de compte et les mises à jour du produit.",
    comparisonFbSection1Title: "1) Mise en ligne assistée par IA à partir de photos",
    comparisonFbSection1Body: "Sur PopOut, le téléchargement des photos de l'article peut générer un brouillon de titre, de description et des suggestions de catégorie. L'utilisateur vérifie, complète, indique l'état et le prix, puis publie plus vite avec moins d'étapes manuelles.",
    comparisonFbSection2Title: "2) Communication multilingue en temps réel",
    comparisonFbSection2Body: "PopOut prend en charge l'anglais, le chinois simplifié, le chinois traditionnel, le coréen, le japonais, le français, l'espagnol et le vietnamien. Les annonces et les conversations peuvent être lues dans la langue préférée de chaque utilisateur.",
    comparisonFbSection3Title: "3) Conseils de zones sûres et confirmation des rencontres",
    comparisonFbSection3Body: "PopOut recommande des lieux de rencontre plus sûrs à proximité et propose un déroulé de rendez-vous. Après accord, le QR du vendeur et le scan sur place de l'acheteur peuvent servir d'étape de confirmation, pour une meilleure gestion des absences.",
    comparisonFbSection4Title: "4) Parcours de vérification étudiante à Melbourne",
    comparisonFbSection4Body: "Pour les communautés étudiantes et les regroupements de logements, PopOut inclut un canal de vérification étudiante afin de renforcer la confiance et la visibilité dans les transactions liées au campus.",
    comparisonFbTableTitle: "Aperçu des fonctionnalités (point de vue utilisateur)",
    comparisonFbTableNote: "Remarque : la colonne de droite reflète des usages publics courants et peut évoluer avec le temps.",
    comparisonFbFeature1Title: "Rapidité de démarrage d'une annonce",
    comparisonFbFeature1Popout: "L'IA rédige le titre/la description/la catégorie à partir des photos",
    comparisonFbFeature1Other: "Repose souvent sur la saisie manuelle du formulaire et le choix de la catégorie",
    comparisonFbFeature2Title: "Messagerie multilingue",
    comparisonFbFeature2Popout: "Le contenu des annonces et des conversations est compréhensible dans les langues prises en charge",
    comparisonFbFeature2Other: "La communication entre langues dépend souvent de l'auto-traduction",
    comparisonFbFeature3Title: "Déroulé de sécurité des rencontres",
    comparisonFbFeature3Popout: "Suggestion de lieu plus sûr + rendez-vous + confirmation QR sur place",
    comparisonFbFeature3Other: "Le déroulé des rencontres est généralement défini par l'utilisateur et moins structuré",
    comparisonFbFeature4Title: "Couche de confiance axée sur les étudiants",
    comparisonFbFeature4Popout: "Parcours de vérification étudiante pour les mises en relation campus/logement",
    comparisonFbFeature4Other: "Le parcours d'identité spécifique aux étudiants est souvent limité ou indisponible",
    comparisonFbFinalTitle: "Comment utiliser cette comparaison",
    comparisonFbFinalBody: "Si vos priorités sont une publication plus rapide, une communication multilingue plus fluide et une meilleure responsabilité lors des rencontres, le fonctionnement de PopOut peut mieux convenir. Vérifiez toujours les détails des fonctionnalités actuelles dans votre propre contexte d'usage.",
    ...
    comparisonFbCard3Title: "Confirmation de rencontre",
    comparisonFbCard3Body: "Rendez-vous et enregistrement QR sur place",
  ...
  es: {
    ...
    heroSecondaryPrefix: "Compra y vende con tus vecinos sin complicaciones, entendiéndote con todos en ",
    ...
    heroRotatingItems: ["muebles", "electrónica", "bicicletas", "libros de texto", "menaje de cocina", "ropa"],
    heroLocationSuffix: "",
    contactBack: "Volver al inicio",
    contactHint: "Cuéntanos tu pregunta o solicitud de colaboración y te responderemos por correo electrónico.",
    ...
    faqIntro: "Estas ocho preguntas frecuentes explican cómo PopOut facilita publicar más rápido, la comunicación multilingüe, transacciones más seguras y las ventas de temporada de graduación en Melbourne.",
    faqDisclaimerTitle: "Nota oficial",
    faqDisclaimerBody: "Esta página es solo informativa sobre el producto y no constituye ninguna garantía legal, financiera ni de seguridad. Las funciones pueden variar según la versión de la app, la región y la cuenta.",
    ...
    comparisonHubIntro: "Esta página te ayuda a entender las diferencias prácticas entre PopOut y otros mercados de segunda mano habituales. El objetivo es una guía clara y transparente para que elijas lo que mejor se adapte a tu forma de usarlo.",
    comparisonHubPurposeTitle: "Por qué existe esta página",
    comparisonHubPurposeBody: "Muchos usuarios tienen dificultades con el llenado repetitivo de formularios, las barreras de idioma y la coordinación de encuentros más seguros. Presentamos la experiencia central de PopOut de forma estructurada para que sea más fácil evaluar las diferencias.",
    comparisonHubDisclaimerTitle: "Nota oficial y aviso legal",
    comparisonHubDisclaimerBody: "Esta página tiene fines únicamente informativos sobre el producto. No constituye asesoramiento legal ni pretende desacreditar a ninguna plataforma de terceros. Las marcas y nombres de productos de terceros pertenecen a sus respectivos propietarios. Las funciones pueden cambiar con el tiempo; verifica los detalles actuales en los canales oficiales de cada plataforma.",
    ...
    comparisonHubCardFbBody: "Compara la rapidez al publicar, los mensajes multilingües y el flujo de seguridad en los encuentros.",
    comparisonHubCardFbCta: "Leer PopOut vs Facebook Marketplace",
    comparisonHubCardGumtreeBody: "Compara la creación de anuncios con IA, la verificación de estudiantes y el flujo para evitar ausencias.",
    comparisonHubCardGumtreeCta: "Leer PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree: comparación de la experiencia",
    comparisonGumtreeLead: "Esta página compara las diferencias prácticas de flujo en la creación de anuncios, la comunicación multilingüe y la seguridad en los encuentros en los usos de segunda mano de Melbourne.",
    comparisonGumtreeDisclaimer: "Aviso: esta página tiene fines únicamente informativos para el usuario y el producto. No constituye asesoramiento legal. Gumtree y las marcas relacionadas pertenecen a sus respectivos propietarios. Las funciones de terceros pueden cambiar con el tiempo.",
    comparisonGumtreeSection1Title: "1) Creación de anuncios asistida por IA",
    comparisonGumtreeSection1Body: "PopOut puede redactar sugerencias de título, descripción y categoría a partir de las fotos del artículo. El usuario las revisa, indica el estado y el precio deseado, y elige opciones como la entrega y la negociación para publicar más rápido.",
    comparisonGumtreeSection2Title: "2) Flujo multilingüe integrado",
    comparisonGumtreeSection2Body: "PopOut admite inglés, chino simplificado, chino tradicional, coreano, japonés, francés, español y vietnamita al publicar y mensajear, reduciendo las barreras de idioma en una ciudad diversa.",
    comparisonGumtreeSection3Title: "3) Seguridad estructurada en los encuentros y gestión de ausencias",
    comparisonGumtreeSection3Body: "PopOut combina sugerencias de zonas de encuentro más seguras, la planificación de citas y la confirmación en el lugar mediante QR. Esto genera registros de finalización más claros y ayuda a gestionar las ausencias.",
    comparisonGumtreeSection4Title: "4) Verificación de estudiantes para comunidades universitarias",
    comparisonGumtreeSection4Body: "Una vía de verificación de estudiantes ayuda a mejorar la confianza y la calidad de las coincidencias en las transacciones vinculadas a universidades y alojamientos en Melbourne.",
    comparisonGumtreeTableTitle: "Resumen de funciones (desde el punto de vista del usuario)",
    comparisonGumtreeTableNote: "Nota: la columna de la derecha describe patrones de uso públicos generales y puede variar según la cuenta, la región o las actualizaciones del producto.",
    comparisonGumtreeFeature1Title: "Tiempo para preparar un anuncio",
    comparisonGumtreeFeature1Popout: "La IA redacta primero los campos clave y el usuario finaliza los detalles",
    comparisonGumtreeFeature1Other: "Por lo general, más trabajo manual del formulario desde el inicio",
    ...
    comparisonGumtreeFeature2Other: "La comunicación entre idiomas suele depender de la traducción del propio usuario",
    comparisonGumtreeFeature3Title: "Responsabilidad en los encuentros",
    comparisonGumtreeFeature3Popout: "Cita + confirmación con QR en el lugar para registros más claros",
    comparisonGumtreeFeature3Other: "La responsabilidad suele basarse en el historial de mensajes privados",
    comparisonGumtreeFeature4Title: "Mecanismo de confianza específico para estudiantes",
    comparisonGumtreeFeature4Popout: "La verificación de estudiantes facilita las coincidencias en el campus",
    ...
    comparisonGumtreeFinalBody: "Si tus prioridades son la rapidez al publicar, la claridad multilingüe y un flujo de confirmación de encuentros más sólido, PopOut puede encajar mejor. Verifica las funciones actuales según tu región y tu uso.",
    ...
    comparisonGumtreeCard3Title: "Seguridad y cumplimiento",
    comparisonGumtreeCard3Body: "Guía de encuentros más seguros y lógica para ausencias",
    comparisonFbH1: "PopOut vs Facebook Marketplace: comparación de la experiencia",
    comparisonFbLead: "Este artículo compara las diferencias prácticas de flujo en la creación de anuncios, la comunicación multilingüe y la seguridad en las transacciones en persona. La intención es ayudarte a elegir un flujo de mercado que se ajuste a tus necesidades diarias.",
    comparisonFbDisclaimer: "Aviso: esta página tiene fines únicamente informativos sobre el producto, no constituye asesoramiento legal ni una declaración negativa sobre ninguna plataforma de terceros. Facebook Marketplace y las marcas relacionadas pertenecen a sus respectivos propietarios. La disponibilidad de funciones puede variar según la región, el tipo de cuenta y las actualizaciones del producto.",
    comparisonFbSection1Title: "1) Creación de anuncios con IA a partir de fotos",
    comparisonFbSection1Body: "En PopOut, subir las fotos del artículo puede generar un borrador de título, descripción y sugerencias de categoría. El usuario revisa, añade contexto, indica el estado y el precio, y publica más rápido con menos pasos manuales.",
    comparisonFbSection2Title: "2) Comunicación multilingüe en tiempo real",
    comparisonFbSection2Body: "PopOut admite inglés, chino simplificado, chino tradicional, coreano, japonés, francés, español y vietnamita. Las publicaciones y los chats pueden leerse en el idioma preferido de cada usuario.",
    comparisonFbSection3Title: "3) Guía de zonas seguras y confirmación de encuentros",
    comparisonFbSection3Body: "PopOut recomienda zonas de encuentro más seguras cercanas y ofrece un flujo de citas. Tras el acuerdo, el QR del vendedor y el escaneo en el lugar del comprador pueden usarse como paso de confirmación, lo que facilita la gestión de las ausencias.",
    comparisonFbSection4Title: "4) Vía de verificación de estudiantes en Melbourne",
    comparisonFbSection4Body: "Para las comunidades estudiantiles y los conjuntos de alojamiento, PopOut incluye un canal de verificación de estudiantes para mejorar la confianza y la visibilidad en las transacciones vinculadas al campus.",
    comparisonFbTableTitle: "Resumen de funciones (desde el punto de vista del usuario)",
    comparisonFbTableNote: "Nota: la columna de la derecha refleja patrones de uso públicos comunes y puede cambiar con el tiempo.",
    comparisonFbFeature1Title: "Rapidez para empezar un anuncio",
    comparisonFbFeature1Popout: "La IA redacta el título/la descripción/la categoría a partir de las fotos",
    comparisonFbFeature1Other: "A menudo depende del llenado manual del formulario y la selección de categoría",
    comparisonFbFeature2Title: "Mensajes multilingües",
    comparisonFbFeature2Popout: "El contenido de publicaciones y chats puede entenderse en los idiomas admitidos",
    comparisonFbFeature2Other: "La comunicación entre idiomas suele depender de la traducción propia",
    comparisonFbFeature3Title: "Flujo de seguridad en los encuentros",
    comparisonFbFeature3Popout: "Sugerencia de zona más segura + cita + confirmación con QR en el lugar",
    comparisonFbFeature3Other: "El proceso de encuentro suele definirlo el usuario y está menos estructurado",
    comparisonFbFeature4Title: "Capa de confianza enfocada en estudiantes",
    comparisonFbFeature4Popout: "Vía de verificación de estudiantes para coincidencias de campus/alojamiento",
    comparisonFbFeature4Other: "El flujo de identidad específico para estudiantes suele ser limitado o no estar disponible",
    comparisonFbFinalTitle: "Cómo usar esta comparación",
    comparisonFbFinalBody: "Si tus prioridades son publicar más rápido, una comunicación multilingüe más fluida y una mayor responsabilidad en los encuentros, el flujo de PopOut puede encajar mejor. Verifica siempre los detalles de las funciones actuales según tu propio uso.",
    ...
    comparisonFbCard3Title: "Confirmación de encuentro",
    comparisonFbCard3Body: "Cita junto con registro mediante QR en el lugar",
