...
export const COPY: Record<Locale, SiteCopy> = {
  en: {
    ...
    marketPostDistanceLabel: "Meet-up distance",
  ...
  "zh-Hans": {
    ...
    marketPostDistanceLabel: "见面距离（直线）",
  ...
  "zh-Hant": {
    ...
    marketPostDistanceLabel: "面交距離（直線）",
  ...
  ko: {
    ...
    marketPostDistanceLabel: "만남 장소까지 거리",
  ...
  ja: {
    ...
    marketPostDistanceLabel: "受け渡し地点までの距離",
  ...
  vi: {
    ...
    marketPostDistanceLabel: "Khoảng cách đến điểm giao",
  ...
  fr: {
    ...
    marketPostDistanceLabel: "Distance jusqu’au point de remise",
  ...
  es: {
    ...
    marketPostDistanceLabel: "Distancia al punto de entrega",
