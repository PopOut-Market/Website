...
export const COPY: Record<Locale, SiteCopy> = {
  en: {
    ...
    scheduleDemoSubtitle: "Pick a time and place, meet your buyer, and scan their QR code to confirm — reducing no-shows and building a trusted community.",
    ...
    studentVerifySubtitle: "Verify your student email to earn a trust badge — making every transaction in the community safer and more reliable.",
  ...
  ko: {
    ...
    scheduleDemoSubtitle: "시간과 장소를 정하고, 만나서 QR을 스캔하면 확인 완료 — 노쇼를 줄이고 신뢰를 쌓아요.",
    scheduleDemoDate: "날짜",
    scheduleDemoTime: "시간",
    ...
    studentVerifySubtitle: "학생 이메일을 인증하고 신뢰 배지를 받으세요 — 커뮤니티의 모든 거래를 더 안전하게.",
  ...
  ja: {
    ...
    scheduleDemoSubtitle: "日時と場所を決めて、会ったらQRをスキャン——ノーショーを減らし、信頼あるコミュニティへ。",
    scheduleDemoDate: "日時",
    scheduleDemoTime: "時間",
    ...
    studentVerifySubtitle: "学生メールを認証して信頼バッジを獲得——コミュニティの取引をより安全・安心に。",
  ...
  vi: {
    ...
    scheduleDemoSubtitle: "Chọn thời gian và địa điểm, gặp mặt rồi quét mã QR xác nhận — giảm vắng mặt, xây dựng cộng đồng tin cậy.",
    ...
    studentVerifySubtitle: "Xác minh email sinh viên để nhận huy hiệu tin cậy — mỗi giao dịch trong cộng đồng đều an toàn hơn.",
  ...
  fr: {
    ...
    scheduleDemoSubtitle: "Choisissez un créneau et un lieu, retrouvez l'acheteur et scannez le QR pour confirmer — moins de faux bonds, plus de confiance.",
    scheduleDemoDate: "Date",
    ...
    studentVerifySubtitle: "Vérifiez votre e-mail étudiant pour obtenir un badge de confiance — chaque transaction dans la communauté plus sûre.",
  ...
  es: {
    ...
    scheduleDemoSubtitle: "Elige hora y lugar, encuentra al comprador y escanea su QR para confirmar — menos plantones y más confianza en tu comunidad.",
    ...
    studentVerifySubtitle: "Verifica tu correo estudiantil para obtener una insignia de confianza — cada operación en la comunidad más segura.",
