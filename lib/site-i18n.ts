...
export const COPY: Record<Locale, SiteCopy> = {
  en: {
    ...
    comparisonHubPurposeBody: "Many users struggle with repetitive form filling, language barriers, and handling a high volume of repetitive buyer messages. We present PopOut's core experience in a structured format so feature differences are easier to evaluate.",
    ...
    comparisonHubCardGumtreeBody: "Compare AI listing setup, student verification, and AI auto-reply.",
    comparisonHubCardGumtreeCta: "Read PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree: Experience Comparison",
    comparisonGumtreeLead: "This page compares real-world workflow differences around listing setup, multilingual communication, and AI auto-reply in Melbourne second-hand use cases.",
    ...
    comparisonGumtreeFeature3Popout: "AI handles repetitive questions and details already in your listing; leaves uncertain ones for you",
    comparisonGumtreeFeature3Other: "Replies are fully manual, with no AI help to filter repetitive messages",
    ...
    comparisonGumtreeFinalBody: "If your priorities are posting speed, multilingual clarity, and AI auto-reply that saves time, PopOut may be the better fit. Validate current features based on your own region and usage.",
    ...
    comparisonFbLead: "This article compares practical workflow differences in listing setup, multilingual communication, and AI auto-reply. The intent is to help users choose a marketplace flow that fits everyday needs.",
    ...
    comparisonFbSection3Body: "PopOut includes an AI auto-reply feature. It is simple for now and we are actively improving it, with stronger capabilities coming soon. Today it handles repetitive, low-value messages and answers questions already covered in your listing. For anything uncertain or not written in your post, the AI does not guess — it leaves those for you to reply to the buyer personally, so your time goes to the questions that genuinely matter.",
    ...
    comparisonFbFeature3Popout: "AI replies to repetitive questions and listing details; uncertain ones wait for you",
    comparisonFbFeature3Other: "Messaging is fully manual, with no AI help to handle repetitive questions",
    ...
    comparisonFbFinalBody: "If your priorities are faster posting, smoother multilingual communication, and AI auto-reply that handles repetitive questions, PopOut's workflow may fit better. Always verify current feature details in your own usage context.",
  ...
  "zh-Hans": {
    ...
    comparisonHubPurposeBody: "许多用户在反复填写表单、应对语言障碍，以及处理大量重复的买家咨询时感到吃力。我们以结构化的方式呈现 PopOut Market 的核心体验，让你更容易评估各项功能的差异。",
    ...
    comparisonGumtreeLead: "本页围绕墨尔本二手交易场景，对比发布设置、多语言沟通和 AI 自动回复在实际使用流程中的差异。",
    ...
    comparisonGumtreeSection3Body: "PopOut 内置了 AI 自动回复功能。目前功能还比较简单，我们正在持续优化，更强大的能力很快就会上线。现在它可以应对大量重复、价值不高的消息，并回答你在商品描述中已经写明的问题。对于不确定或描述里没有提到的内容，AI 不会贸然作答，而是留给你亲自回复买家，让你把精力集中在真正重要的问题上。",
    ...
    comparisonGumtreeFinalBody: "如果你更看重发布速度、多语言沟通的清晰度，以及能节省时间的 AI 自动回复，那么 PopOut Market 可能更适合你。请结合你所在地区和使用习惯，自行确认当前的功能。",
    ...
    comparisonFbLead: "本文对比发布设置、多语言沟通和 AI 自动回复在实际使用流程中的差异，旨在帮助用户选择更契合日常需求的交易流程。",
    ...
    comparisonFbSection3Body: "PopOut 内置了 AI 自动回复功能。目前功能还比较简单，我们正在持续优化，更强大的能力很快就会上线。现在它可以应对大量重复、价值不高的消息，并回答你在商品描述中已经写明的问题。对于不确定或描述里没有提到的内容，AI 不会贸然作答，而是留给你亲自回复买家，把时间花在真正重要的问题上。",
    ...
    comparisonFbFinalBody: "如果你更看重更快的发布、更顺畅的多语言沟通，以及能帮你处理重复提问的 AI 自动回复，那么 PopOut Market 的使用流程可能更适合你。请务必结合你自身的使用场景，确认当前的具体功能细节。",
  ...
  "zh-Hant": {
    ...
    comparisonHubPurposeBody: "許多使用者常為重複填寫表單、語言隔閡，以及應付大量重複的買家訊息所困擾。我們以結構化的方式呈現 PopOut 的核心體驗，讓功能差異更容易評估與比較。",
    ...
    comparisonGumtreeLead: "本頁以墨爾本二手交易的實際情境，比較刊登設定、多語溝通，以及 AI 自動回覆在實務操作流程上的差異。",
    ...
    comparisonGumtreeSection3Body: "PopOut Market 內建 AI 自動回覆功能。目前功能還算簡單，我們也正持續優化，更強大的能力即將推出。現階段它能處理大量重複、價值不高的訊息，並回答你已寫在商品說明裡的問題。至於不確定或商品說明中沒有提到的內容，AI 不會貿然猜測作答，而是留給你親自回覆買家，讓你能把心力放在真正重要的問題上。",
    ...
    comparisonGumtreeFeature3Popout: "AI 負責回答重複問題與商品說明中已有的資訊，不確定的則留給你處理",
    ...
    comparisonGumtreeFinalBody: "如果你重視刊登速度、多語溝通的清晰度，以及能節省時間的 AI 自動回覆，PopOut 可能更適合你。請依你所在地區與實際使用情況，確認目前的功能內容。",
    ...
    comparisonFbLead: "本文比較刊登設定、多語溝通，以及 AI 自動回覆在實務操作流程上的差異，目的是協助使用者選擇真正貼合日常需求的交易流程。",
    ...
    comparisonFbSection3Body: "PopOut Market 內建 AI 自動回覆功能。目前功能還算簡單，我們也正持續優化，更強大的能力即將推出。現階段它能處理重複、價值不高的訊息，並回答你已寫在商品說明裡的問題。至於不確定或商品說明中沒有提到的內容，AI 不會貿然猜測作答，而是留給你親自回覆買家，讓你把時間花在真正重要的問題上。",
    ...
    comparisonFbFinalBody: "如果你重視更快的刊登速度、更順暢的多語溝通，以及能處理重複問題的 AI 自動回覆，PopOut 的操作流程可能更適合你。請務必依你自身的使用情境，確認目前的功能細節。",
  ...
  ko: {
    ...
    comparisonHubPurposeBody: "많은 사용자가 반복적인 양식 입력, 언어 장벽, 그리고 쏟아지는 비슷한 구매자 문의 처리에 어려움을 겪습니다. 기능 차이를 더 쉽게 평가할 수 있도록 PopOut의 핵심 경험을 체계적으로 정리해 소개합니다.",
    ...
    comparisonGumtreeLead: "이 페이지는 멜버른 중고 거래 사용 사례를 중심으로 등록 설정, 다국어 소통, AI 자동 응답에서 나타나는 실제 사용 흐름의 차이를 비교합니다.",
    ...
    comparisonGumtreeSection3Body: "PopOut Market에는 AI 자동 응답 기능이 있습니다. 아직은 단순한 수준이지만 지금도 꾸준히 개선하고 있으며, 더 강력한 기능도 곧 추가될 예정입니다. 현재는 반복적이고 사소한 문의를 대신 처리하고, 게시글에 이미 적어 둔 내용에 관한 질문에 답해 줍니다. 확실하지 않거나 게시글에 없는 내용은 AI가 함부로 추측해 답하지 않고, 판매자가 직접 구매자에게 답할 수 있도록 남겨 둡니다. 덕분에 판매자는 정말 중요한 질문에만 집중할 수 있습니다.",
    ...
    comparisonGumtreeFeature3Popout: "반복되는 질문과 게시글에 이미 있는 정보는 AI가 답하고, 확실하지 않은 질문은 판매자에게 남깁니다",
    comparisonGumtreeFeature3Other: "모든 답변을 직접 입력해야 하며, 반복 문의를 걸러 줄 AI 기능이 없습니다",
    ...
    comparisonGumtreeFinalBody: "등록 속도, 다국어 소통의 명확함, 그리고 시간을 절약해 주는 AI 자동 응답이 중요하다면 PopOut이 더 잘 맞을 수 있습니다. 현재 제공되는 기능은 본인의 지역과 사용 환경을 기준으로 직접 확인해 보세요.",
    ...
    comparisonFbLead: "이 글은 등록 설정, 다국어 소통, AI 자동 응답에서 나타나는 실질적인 사용 흐름의 차이를 비교합니다. 일상적인 필요에 맞는 마켓플레이스 사용 흐름을 선택하시는 데 도움을 드리는 것이 목적입니다.",
    ...
    comparisonFbSection3Body: "PopOut Market에는 AI 자동 응답 기능이 있습니다. 아직은 단순한 수준이지만 지금도 꾸준히 개선하고 있으며, 더 강력한 기능도 곧 추가될 예정입니다. 현재는 반복적이고 사소한 문의를 대신 처리하고, 게시글에 이미 적어 둔 내용에 관한 질문에 답해 줍니다. 확실하지 않거나 게시글에 없는 내용은 AI가 함부로 추측해 답하지 않고, 판매자가 직접 구매자에게 답할 수 있도록 남겨 둡니다. 그래서 판매자는 정말 중요한 질문에만 시간을 쓸 수 있습니다.",
    ...
    comparisonFbFeature3Popout: "반복되는 질문과 게시글에 있는 정보는 AI가 답하고, 확실하지 않은 질문은 판매자에게 남깁니다",
    comparisonFbFeature3Other: "메시지를 전부 직접 보내야 하며, 반복 문의를 처리해 줄 AI 기능이 없습니다",
    ...
    comparisonFbFinalBody: "더 빠른 등록, 더 매끄러운 다국어 소통, 그리고 반복되는 질문을 처리해 주는 AI 자동 응답이 중요하다면 PopOut의 사용 흐름이 더 잘 맞을 수 있습니다. 현재 기능의 세부 사항은 항상 본인의 사용 환경에서 직접 확인하시기 바랍니다.",
  ...
  ja: {
    ...
    comparisonHubPurposeBody: "多くのユーザーは、繰り返しのフォーム入力、言葉の壁、そして似たような内容で大量に寄せられる購入希望者からのメッセージへの対応に悩んでいます。PopOutの中核となる体験を整理してご紹介することで、機能の違いを評価しやすくしています。",
    ...
    comparisonGumtreeLead: "このページでは、メルボルンでの中古品取引を想定し、出品設定、多言語コミュニケーション、AI自動返信における実際のワークフローの違いを比較します。",
    ...
    comparisonGumtreeSection3Body: "PopOut MarketにはAI自動返信機能が搭載されています。現時点ではシンプルな機能ですが、現在も改良を重ねており、さらに便利な機能を近日中に追加する予定です。今のところ、繰り返し寄せられる簡単なメッセージや、出品情報にすでに記載されている内容についての質問にAIが対応します。判断が難しいことや投稿に書かれていないことについては、AIが推測で答えることはなく、出品者ご自身が購入希望者に直接お答えいただけるよう残しておきます。これにより、本当に大切な質問に集中していただけます。",
    ...
    comparisonGumtreeFeature3Popout: "繰り返しの質問や出品情報に記載済みの内容にはAIが対応し、判断が難しいものは出品者にお任せします",
    comparisonGumtreeFeature3Other: "返信はすべて手動で、繰り返しのメッセージを振り分けるAIのサポートはありません",
    ...
    comparisonGumtreeFinalBody: "出品のスピード、多言語でのわかりやすさ、そして時間を節約できるAI自動返信を重視するなら、PopOutのほうが適しているかもしれません。最新の機能については、ご自身の地域や利用状況に合わせてご確認ください。",
    ...
    comparisonFbLead: "この記事では、出品設定、多言語コミュニケーション、AI自動返信における実際のワークフローの違いを比較します。日々のニーズに合ったマーケットプレイスの選び方をサポートすることを目的としています。",
    ...
    comparisonFbSection3Body: "PopOut MarketにはAI自動返信機能が搭載されています。現時点ではシンプルな機能ですが、現在も改良を重ねており、さらに便利な機能を近日中に追加する予定です。今のところ、繰り返し寄せられる簡単なメッセージや、出品情報にすでに記載されている内容についての質問にAIが対応します。判断が難しいことや投稿に書かれていないことについては、AIが推測で答えることはなく、出品者ご自身が購入希望者に直接お答えいただけるよう残しておきます。これにより、本当に大切な質問に時間を使っていただけます。",
    ...
    comparisonFbFeature3Popout: "繰り返しの質問や出品情報に記載済みの内容にはAIが対応し、判断が難しいものは出品者にお任せします",
    comparisonFbFeature3Other: "メッセージのやり取りはすべて手動で、繰り返しの質問に対応するAIのサポートはありません",
    ...
    comparisonFbFinalBody: "より速い出品、よりスムーズな多言語コミュニケーション、そして繰り返し寄せられる質問に対応するAI自動返信を重視するなら、PopOutのワークフローのほうが合っているかもしれません。最新の機能の詳細は、必ずご自身の利用状況に合わせてご確認ください。",
  ...
  vi: {
    ...
    comparisonHubPurposeBody: "Nhiều người dùng gặp khó khăn với việc điền biểu mẫu lặp đi lặp lại, rào cản ngôn ngữ và việc xử lý một lượng lớn tin nhắn trùng lặp từ người mua. Chúng tôi trình bày trải nghiệm cốt lõi của PopOut theo một định dạng có cấu trúc để bạn dễ dàng đánh giá những khác biệt về tính năng.",
    ...
    comparisonHubCardFbBody: "So sánh tốc độ đăng tin, nhắn tin đa ngôn ngữ và tính năng trả lời tự động bằng AI.",
    comparisonHubCardFbCta: "Đọc PopOut vs Facebook Marketplace",
    comparisonHubCardGumtreeBody: "So sánh quy trình đăng tin bằng AI, tính năng xác minh sinh viên và trả lời tự động bằng AI.",
    comparisonHubCardGumtreeCta: "Đọc PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree: So sánh trải nghiệm",
    comparisonGumtreeLead: "Trang này so sánh những khác biệt trong quy trình thực tế liên quan đến việc đăng tin, giao tiếp đa ngôn ngữ và tính năng trả lời tự động bằng AI trong các trường hợp mua bán đồ cũ tại Melbourne.",
    ...
    comparisonGumtreeFeature3Popout: "AI trả lời các câu hỏi lặp lại và thông tin đã có trong tin đăng; những câu chưa chắc chắn thì để lại cho bạn",
    comparisonGumtreeFeature3Other: "Mọi phản hồi đều phải làm thủ công, không có AI hỗ trợ lọc tin nhắn lặp lại",
    ...
    comparisonGumtreeFinalBody: "Nếu ưu tiên của bạn là tốc độ đăng tin, sự rõ ràng khi giao tiếp đa ngôn ngữ và tính năng trả lời tự động bằng AI giúp tiết kiệm thời gian, thì PopOut có thể là lựa chọn phù hợp hơn. Hãy tự kiểm chứng các tính năng hiện có dựa trên khu vực và cách sử dụng của riêng bạn.",
    ...
    comparisonFbLead: "Bài viết này so sánh những khác biệt thực tế trong quy trình đăng tin, giao tiếp đa ngôn ngữ và tính năng trả lời tự động bằng AI. Mục đích là giúp người dùng chọn được một quy trình mua bán phù hợp với nhu cầu hằng ngày.",
    ...
    comparisonFbFeature3Popout: "AI trả lời các câu hỏi lặp lại và thông tin đã có trong tin đăng; những câu chưa chắc chắn sẽ chờ bạn xử lý",
    comparisonFbFeature3Other: "Việc nhắn tin hoàn toàn thủ công, không có AI hỗ trợ xử lý các câu hỏi lặp lại",
    ...
    comparisonFbFinalBody: "Nếu ưu tiên của bạn là đăng tin nhanh hơn, giao tiếp đa ngôn ngữ mượt mà hơn và tính năng trả lời tự động bằng AI giúp xử lý những câu hỏi lặp đi lặp lại, thì quy trình của PopOut có thể phù hợp hơn với bạn. Hãy luôn tự xác minh chi tiết các tính năng hiện có trong bối cảnh sử dụng của riêng bạn.",
    ...
    comparisonFbCard3Body: "AI xử lý các câu hỏi lặp lại để bạn tập trung vào những câu hỏi thực sự quan trọng",
  ...
  fr: {
    ...
    comparisonHubCardFbBody: "Comparez la rapidité de publication, la messagerie multilingue et la réponse automatique par IA.",
    comparisonHubCardFbCta: "Lire PopOut vs Facebook Marketplace",
    comparisonHubCardGumtreeBody: "Comparez la création d'annonces par IA, la vérification du statut étudiant et la réponse automatique par IA.",
    comparisonHubCardGumtreeCta: "Lire PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree : comparaison de l'expérience",
    comparisonGumtreeLead: "Cette page compare les différences concrètes de flux de travail concernant la création d'annonces, la communication multilingue et la réponse automatique par IA, dans des cas d'usage de seconde main à Melbourne.",
    ...
    comparisonGumtreeFeature3Popout: "L'IA traite les questions répétitives et les détails déjà présents dans votre annonce, et vous laisse les cas incertains",
    comparisonGumtreeFeature3Other: "Les réponses sont entièrement manuelles, sans aide de l'IA pour filtrer les messages répétitifs",
    ...
    comparisonGumtreeFinalBody: "Si vos priorités sont la rapidité de publication, la clarté multilingue et une réponse automatique par IA qui vous fait gagner du temps, PopOut peut être le meilleur choix. Vérifiez les fonctionnalités actuelles en fonction de votre propre région et de votre usage.",
    ...
    comparisonGumtreeCard3Body: "L'IA répond aux questions répétitives pour vous faire gagner du temps",
    comparisonFbH1: "PopOut vs Facebook Marketplace : comparaison de l'expérience",
    comparisonFbLead: "Cet article compare les différences pratiques de flux de travail dans la création d'annonces, la communication multilingue et la réponse automatique par IA. L'objectif est d'aider les utilisateurs à choisir un flux de marketplace adapté à leurs besoins quotidiens.",
    ...
    comparisonFbFeature3Popout: "L'IA répond aux questions répétitives et aux détails de l'annonce ; les cas incertains vous reviennent",
    comparisonFbFeature3Other: "La messagerie est entièrement manuelle, sans aide de l'IA pour gérer les questions répétitives",
    ...
    comparisonFbCard3Body: "L'IA gère les questions répétitives pour que vous puissiez vous concentrer sur les vraies",
  ...
  es: {
    ...
    comparisonHubCardFbBody: "Compara la rapidez para publicar, la mensajería multilingüe y la respuesta automática con IA.",
    comparisonHubCardFbCta: "Leer PopOut vs Facebook Marketplace",
    comparisonHubCardGumtreeBody: "Compara la configuración de anuncios con IA, la verificación de estudiantes y la respuesta automática con IA.",
    comparisonHubCardGumtreeCta: "Leer PopOut vs Gumtree",
    comparisonGumtreeH1: "PopOut vs Gumtree: comparación de la experiencia",
    comparisonGumtreeLead: "Esta página compara las diferencias reales de flujo de trabajo en la configuración de anuncios, la comunicación multilingüe y la respuesta automática con IA en casos de uso de segunda mano en Melbourne.",
    ...
    comparisonGumtreeFeature3Popout: "La IA se encarga de las preguntas repetitivas y de los detalles que ya están en tu anuncio; las dudas las deja para ti",
    comparisonGumtreeFeature3Other: "Las respuestas son totalmente manuales, sin ninguna IA que filtre los mensajes repetitivos",
    ...
    comparisonGumtreeFinalBody: "Si tus prioridades son la rapidez al publicar, la claridad multilingüe y una respuesta automática con IA que te ahorre tiempo, PopOut puede ser la mejor opción. Comprueba las funciones disponibles actualmente según tu región y tu forma de uso.",
    ...
    comparisonFbLead: "Este artículo compara las diferencias prácticas de flujo de trabajo en la configuración de anuncios, la comunicación multilingüe y la respuesta automática con IA. La intención es ayudar a los usuarios a elegir un marketplace cuyo flujo de trabajo se adapte a sus necesidades cotidianas.",
    ...
    comparisonFbFeature3Popout: "La IA responde las preguntas repetitivas y los detalles que ya están en tu anuncio; las dudas quedan a la espera de tu respuesta",
    comparisonFbFeature3Other: "La mensajería es totalmente manual, sin ninguna IA que gestione las preguntas repetitivas",
    ...
    comparisonFbFinalBody: "Si tus prioridades son publicar más rápido, una comunicación multilingüe más fluida y una respuesta automática con IA que gestione las preguntas repetitivas, el flujo de trabajo de PopOut puede encajar mejor. Comprueba siempre los detalles actuales de las funciones según tu propio contexto de uso.",
    ...
    comparisonFbCard3Body: "La IA se encarga de las preguntas repetitivas para que te centres en las que de verdad importan",
